...
class fazyrv(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(
            config["PATH"] if "PATH" in config else "", "fazyrv"
        )
    ...
    def build(self, isa_yaml, platform_yaml):
        ...
        # for fazyrv start building the '--isa' argument. the self.isa is dutnmae specific and may not be
        # useful for all DUTs
    ...
    def runTests(self, testList):
        ...
        for testname in testList:
            ...
            cmd = self.compile_cmd.format(
                marchstr, self.xlen, test, elf, compile_macros
            )
